  ...
  return (
    <ResultLayout title="Age & Gender Results" sessionId="FCO-AGE-2026" backHref="/age-gender" backLabel="New Analysis">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="glass-panel p-8 mb-6">
        <h3 className="text-xs uppercase tracking-[0.2em] text-white/40 mb-8 font-bold border-b border-white/5 pb-4">Age Estimation Trend</h3>
          ...
          {trend.map((val, i) => {
            ...
            return (
              <div key={i} className="flex-1 flex flex-col items-center gap-1">
                ...
                <div className="w-full bg-white/20 rounded-t-sm hover:bg-white/40 transition-colors" style={{ height: `${height}%` }} />
              </div>
            );
          })}
        </div>
